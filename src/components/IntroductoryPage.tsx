...
export const IntroductoryPage: React.FC<IntroductoryPageProps> = ({
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 selection:bg-blue-600 selection:text-white relative overflow-x-hidden font-sans transition-colors duration-300">
      
      {/* Dynamic Background Gradients & Glow Effects */}
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-blue-600/10 dark:bg-blue-600/15 rounded-full blur-3xl"></div>
        <div className="absolute top-1/3 -left-40 w-[600px] h-[500px] bg-indigo-600/5 dark:bg-indigo-600/10 rounded-full blur-3xl"></div>
        <div className="absolute top-2/3 -right-40 w-[600px] h-[500px] bg-cyan-600/5 dark:bg-cyan-600/10 rounded-full blur-3xl"></div>
        <div className="absolute inset-0 bg-[radial-gradient(#94a3b8_1px,transparent_1px)] dark:bg-[radial-gradient(#1e293b_1px,transparent_1px)] [background-size:24px_24px] opacity-20 dark:opacity-30"></div>
      </div>

      {/* Top Floating Glass Navigation */}
      <header className="sticky top-0 z-50 backdrop-blur-xl bg-white/90 dark:bg-slate-950/80 border-b border-slate-200/90 dark:border-slate-800/80 shadow-xs transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <div>
              <div className="flex items-center space-x-1.5">
                <span className="font-extrabold text-sm sm:text-base tracking-tight text-slate-900 dark:text-white">
                  CURRICULUM <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500 dark:from-cyan-400 dark:to-blue-400">ARCHITECT</span>
                </span>
                <span className="hidden md:inline-block px-2 py-0.5 rounded-full bg-blue-50 dark:bg-blue-500/20 text-blue-700 dark:text-blue-300 text-[10px] font-bold border border-blue-200 dark:border-blue-400/30">
                  FUTMinna B.Tech IT
                </span>
              </div>
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <button
              ...
              className="p-2 rounded-xl bg-slate-100 hover:bg-slate-200 dark:bg-slate-900 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white border border-slate-200 dark:border-slate-800 transition-all flex items-center justify-center min-h-[36px] min-w-[36px] shadow-xs cursor-pointer"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-14 space-y-16 sm:space-y-24">
        ...
        <section className="relative">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            >
              <div className="relative mx-auto max-w-lg lg:max-w-none rounded-3xl p-1 bg-gradient-to-b from-blue-500/30 via-slate-200/70 dark:via-slate-800/60 to-cyan-500/20 border border-slate-200 dark:border-slate-700/80 shadow-2xl overflow-hidden">
                
                {/* Visual Native UI Container */}
                <div className="rounded-[22px] bg-white dark:bg-slate-950 p-4 sm:p-5 space-y-4 border border-slate-200/90 dark:border-slate-800 shadow-inner">
                  ...
                  <div className="flex items-center justify-between pb-3 border-b border-slate-200 dark:border-slate-800">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-[11px] font-mono text-slate-500 dark:text-slate-400 pl-1">planner_engine.ccmas</span>
                    </div>
                    <span className="px-2 py-0.5 rounded-md bg-emerald-50 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-500/20 text-[10px] font-mono font-bold flex items-center gap-1">
                  ...
                  <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 flex items-center justify-between">
                    <div>
                      <div className="text-[10px] text-slate-500 dark:text-slate-400 font-medium">Active Degree Profile</div>
                      <div className="text-xs font-bold text-slate-900 dark:text-white">300L Harmattan Semester</div>
                    </div>
                    <div className="text-right">
                      <div className="text-[10px] text-slate-500 dark:text-slate-400 font-medium">Load Units</div>
                      <div className="text-xs font-mono font-bold text-blue-600 dark:text-cyan-400">18 / 24 Units</div>
                    </div>
                  </div>

                  {/* Course Cards Preview */}
                  <div className="space-y-2">
                    <div className="p-2.5 rounded-xl bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 hover:border-blue-400 dark:hover:border-blue-500/40 transition-colors flex items-center justify-between">
                      <div className="flex items-center space-x-2.5 min-w-0">
                        <div className="w-7 h-7 rounded-lg bg-blue-100 dark:bg-blue-500/20 text-blue-700 dark:text-blue-400 flex items-center justify-center font-mono font-bold text-[10px] shrink-0">
                          3U
                        </div>
                        <div className="min-w-0">
                          <div className="text-xs font-bold text-slate-900 dark:text-slate-200 truncate">ITP 311: Web App Architecture</div>
                          <div className="text-[10px] text-slate-500 dark:text-slate-400">Mon 10:00 - 12:00 • LT II</div>
                        </div>
                      </div>
                      <span className="text-[10px] font-semibold text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-200 dark:border-emerald-800/60 px-2 py-0.5 rounded-md shrink-0">
                        Prereq OK
                      </span>
                    </div>
                    ...
                    <div className="p-2.5 rounded-xl bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 hover:border-blue-400 dark:hover:border-blue-500/40 transition-colors flex items-center justify-between">
                      <div className="flex items-center space-x-2.5 min-w-0">
                        <div className="w-7 h-7 rounded-lg bg-indigo-100 dark:bg-indigo-500/20 text-indigo-700 dark:text-indigo-400 flex items-center justify-center font-mono font-bold text-[10px] shrink-0">
                          3U
                        </div>
                        <div className="min-w-0">
                          <div className="text-xs font-bold text-slate-900 dark:text-slate-200 truncate">ITP 313: Operating Systems</div>
                          <div className="text-[10px] text-slate-500 dark:text-slate-400">Wed 08:00 - 10:00 • SICT Lab 1</div>
                        </div>
                      </div>
                      <span className="text-[10px] font-semibold text-blue-700 dark:text-cyan-400 bg-blue-50 dark:bg-cyan-950/60 border border-blue-200 dark:border-cyan-800/60 px-2 py-0.5 rounded-md shrink-0">
                        Core Unit
                      </span>
                    </div>
                    ...
                    <div className="p-2.5 rounded-xl bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 hover:border-blue-400 dark:hover:border-blue-500/40 transition-colors flex items-center justify-between">
                      <div className="flex items-center space-x-2.5 min-w-0">
                        <div className="w-7 h-7 rounded-lg bg-cyan-100 dark:bg-cyan-500/20 text-cyan-700 dark:text-cyan-400 flex items-center justify-center font-mono font-bold text-[10px] shrink-0">
                          3U
                        </div>
                        <div className="min-w-0">
                          <div className="text-xs font-bold text-slate-900 dark:text-slate-200 truncate">ITP 315: Database Systems</div>
                          <div className="text-[10px] text-slate-500 dark:text-slate-400">Thu 14:00 - 16:00 • ETF Hall</div>
                        </div>
                      </div>
                      <span className="text-[10px] font-semibold text-purple-700 dark:text-purple-400 bg-purple-50 dark:bg-purple-950/60 border border-purple-200 dark:border-purple-800/60 px-2 py-0.5 rounded-md shrink-0">
                        AI Matched
                      </span>
                    </div>
                  </div>
                  ...
                  {/* Footer Metrics */}
                  <div className="grid grid-cols-3 gap-2 pt-2 border-t border-slate-200 dark:border-slate-800 text-[10px]">
                    <div className="p-2 rounded-lg bg-slate-100 dark:bg-slate-900/80 text-center border border-slate-200/80 dark:border-transparent">
                      <div className="text-slate-500 dark:text-slate-400">Curriculum</div>
                      <div className="text-slate-900 dark:text-white font-bold">5-Year B.Tech</div>
                    </div>
                    <div className="p-2 rounded-lg bg-slate-100 dark:bg-slate-900/80 text-center border border-slate-200/80 dark:border-transparent">
                      <div className="text-slate-500 dark:text-slate-400">Courses</div>
                      <div className="text-slate-900 dark:text-white font-bold">70+ Units</div>
                    </div>
                    <div className="p-2 rounded-lg bg-slate-100 dark:bg-slate-900/80 text-center border border-slate-200/80 dark:border-transparent">
                      <div className="text-slate-500 dark:text-slate-400">Career Radar</div>
                      <div className="text-emerald-600 dark:text-emerald-400 font-bold">5 Tracks</div>
                    </div>
                  </div>
        ...
        <section className="space-y-8">
          <div className="text-center max-w-3xl mx-auto space-y-3">
            <div className="inline-flex items-center space-x-2 text-xs font-extrabold uppercase tracking-wider text-blue-700 dark:text-cyan-400 bg-blue-50 dark:bg-cyan-950/60 px-3 py-1 rounded-full border border-blue-200 dark:border-cyan-800/60">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <div className="bg-white dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 hover:border-blue-400 dark:hover:border-blue-500/50 rounded-2xl p-5 space-y-3 shadow-md hover:shadow-lg transition-all hover:-translate-y-1">
              ...
              <h3 className="font-bold text-slate-900 dark:text-white text-base">Prerequisite Safeguards</h3>
            ...
            <div className="bg-white dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 hover:border-emerald-400 dark:hover:border-emerald-500/50 rounded-2xl p-5 space-y-3 shadow-md hover:shadow-lg transition-all hover:-translate-y-1">
              <div className="w-10 h-10 rounded-xl bg-emerald-50 dark:bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-500/30 flex items-center justify-center">
                <CalendarCheck className="w-5 h-5" />
              </div>
              <h3 className="font-bold text-slate-900 dark:text-white text-base">Timetable Clash Detection</h3>
              <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
            ...
            <div className="bg-white dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 hover:border-amber-400 dark:hover:border-amber-500/50 rounded-2xl p-5 space-y-3 shadow-md hover:shadow-lg transition-all hover:-translate-y-1">
              <div className="w-10 h-10 rounded-xl bg-amber-50 dark:bg-amber-500/20 text-amber-600 dark:text-amber-400 border border-amber-200 dark:border-amber-500/30 flex items-center justify-center">
                <SlidersHorizontal className="w-5 h-5" />
              </div>
              <h3 className="font-bold text-slate-900 dark:text-white text-base">Credit Load Governance</h3>
              <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
            ...
            <div className="bg-white dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 hover:border-purple-400 dark:hover:border-purple-500/50 rounded-2xl p-5 space-y-3 shadow-md hover:shadow-lg transition-all hover:-translate-y-1">
              <div className="w-10 h-10 rounded-xl bg-purple-50 dark:bg-purple-500/20 text-purple-600 dark:text-purple-400 border border-purple-200 dark:border-purple-500/30 flex items-center justify-center">
                <BookOpen className="w-5 h-5" />
              </div>
              <h3 className="font-bold text-slate-900 dark:text-white text-base">Targeted Career Electives</h3>
              <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
        ...
        <section className="space-y-12">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-3">
            <div className="inline-flex items-center space-x-2 text-xs font-extrabold uppercase tracking-wider text-blue-700 dark:text-blue-400 bg-blue-50 dark:bg-blue-950/60 px-3 py-1 rounded-full border border-blue-200 dark:border-blue-800/60">
          ...
          <div className="space-y-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 sm:p-8 shadow-md">
              <div className="lg:col-span-6 space-y-4">
                <div className="inline-flex items-center space-x-2 text-xs font-bold text-blue-700 dark:text-cyan-400 bg-blue-50 dark:bg-cyan-950/80 px-3 py-1 rounded-full border border-blue-200 dark:border-cyan-800/80">
              ...
              <div className="lg:col-span-6 rounded-2xl border border-slate-200 dark:border-slate-700/80 shadow-lg bg-slate-50 dark:bg-slate-950 p-5 space-y-4">
                <div className="flex items-center justify-between pb-3 border-b border-slate-200 dark:border-slate-800">
                  <div className="flex items-center space-x-2">
                    <Briefcase className="w-4 h-4 text-blue-600 dark:text-cyan-400" />
                    <span className="text-xs font-bold text-slate-900 dark:text-white">Skill Coverage Matrix</span>
                  </div>
                  <span className="text-[10px] font-mono text-blue-700 dark:text-cyan-300 bg-blue-50 dark:bg-cyan-950/80 px-2 py-0.5 rounded border border-blue-200 dark:border-cyan-800/60 font-bold">
                ...
                <div className="space-y-3">
                  <div>
                    <div className="flex justify-between text-[11px] font-semibold text-slate-700 dark:text-slate-300 mb-1">
                      ...
                      <span className="text-blue-600 dark:text-cyan-400 font-mono">94%</span>
                    </div>
                  ...
                  <div>
                    <div className="flex justify-between text-[11px] font-semibold text-slate-700 dark:text-slate-300 mb-1">
                      ...
                      <span className="text-indigo-600 dark:text-indigo-400 font-mono">92%</span>
                    </div>
                    <div className="w-full h-2 rounded-full bg-slate-200 dark:bg-slate-800 overflow-hidden">
                ...
                <div className="pt-2 border-t border-slate-200 dark:border-slate-800/80 space-y-2">
                  <div className="text-[10px] text-slate-500 dark:text-slate-400 font-semibold uppercase tracking-wider">Top Recommended Electives</div>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-[11px]">
                    <div className="p-2 rounded-lg bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex items-center justify-between shadow-xs">
                      <span className="text-slate-800 dark:text-slate-200 font-medium">ITP 413 Cloud Systems</span>
                      <span className="text-blue-600 dark:text-cyan-400 font-bold">+15% Skill</span>
                    </div>
                    <div className="p-2 rounded-lg bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex items-center justify-between shadow-xs">
                      <span className="text-slate-800 dark:text-slate-200 font-medium">CPT 421 Virtualization</span>
                      <span className="text-emerald-600 dark:text-emerald-400 font-bold">+12% Skill</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 sm:p-8 shadow-md">
              ...
              <div className="lg:col-span-6 order-2 lg:order-1 rounded-2xl border border-slate-200 dark:border-slate-700/80 shadow-lg bg-slate-50 dark:bg-slate-950 p-5 space-y-4">
                <div className="flex items-center justify-between pb-3 border-b border-slate-200 dark:border-slate-800">
                  <div className="flex items-center space-x-2">
                    <ShieldCheck className="w-4 h-4 text-emerald-600 dark:text-emerald-400" />
                    <span className="text-xs font-bold text-slate-900 dark:text-white">8-Dimension Senate Audit</span>
                  </div>
                  <span className="text-[10px] font-mono text-emerald-700 dark:text-emerald-300 bg-emerald-50 dark:bg-emerald-950/80 px-2 py-0.5 rounded border border-emerald-200 dark:border-emerald-800/60 font-bold">
                ...
                <div className="space-y-2 text-xs">
                  <div className="p-2.5 rounded-xl bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 flex items-center justify-between shadow-xs">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-slate-800 dark:text-slate-200 font-medium">NUC CCMAS Total Graduation Units</span>
                    </div>
                    <span className="font-mono text-emerald-600 dark:text-emerald-400 font-bold text-[11px]">154 / 150 Min</span>
                  </div>

                  <div className="p-2.5 rounded-xl bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 flex items-center justify-between shadow-xs">
                    <div className="flex items-center space-x-2">
                      <CheckCircle2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400 shrink-0" />
                      <span className="text-slate-800 dark:text-slate-200 font-medium">SICT Departmental Core Units</span>
                    </div>
                    <span className="font-mono text-emerald-600 dark:text-emerald-400 font-bold text-[11px]">48 / 48 Cleared</span>
                  </div>

                  <div className="p-2.5 rounded-xl bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 flex items-center justify-between shadow-xs">
                    <div className="flex items-center space-x-2">
                      <CheckCircle2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400 shrink-0" />
                      <span className="text-slate-800 dark:text-slate-200 font-medium">Semester Credit Bounds (15–24)</span>
                    </div>
                    <span className="font-mono text-blue-600 dark:text-cyan-400 font-bold text-[11px]">Validated</span>
                  </div>

                  <div className="p-2.5 rounded-xl bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 flex items-center justify-between shadow-xs">
                    <div className="flex items-center space-x-2">
                      <CheckCircle2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400 shrink-0" />
                      <span className="text-slate-800 dark:text-slate-200 font-medium">SIWES I & II Industrial Placement</span>
                    </div>
                    <span className="font-mono text-purple-600 dark:text-purple-400 font-bold text-[11px]">Logbook OK</span>
                  </div>
                </div>
                ...
                <div className="pt-2 border-t border-slate-200 dark:border-slate-800/80 flex items-center justify-between text-[10px] text-slate-500 dark:text-slate-400">
                  ...
                  <span className="text-emerald-600 dark:text-emerald-400 font-bold">Graduation Ready</span>
                </div>
              </div>

              <div className="lg:col-span-6 order-1 lg:order-2 space-y-4">
                <div className="inline-flex items-center space-x-2 text-xs font-bold text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/80 px-3 py-1 rounded-full border border-emerald-200 dark:border-emerald-800/80">
        ...
        <section className="space-y-8 bg-slate-100/70 dark:bg-slate-900/60 border border-slate-200/90 dark:border-slate-800/90 rounded-3xl p-6 sm:p-10 shadow-xs">
          <div className="text-center max-w-2xl mx-auto space-y-2">
            <div className="inline-flex items-center space-x-2 text-xs font-extrabold uppercase tracking-wider text-amber-700 dark:text-amber-400 bg-amber-50 dark:bg-amber-950/60 px-3 py-1 rounded-full border border-amber-200 dark:border-amber-800/60">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {samplePersonas.map((persona, idx) => (
              <div
                ...
                className="bg-white dark:bg-slate-950/90 hover:bg-slate-50 dark:hover:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-blue-400 dark:hover:border-blue-500/60 rounded-2xl p-5 flex flex-col justify-between space-y-4 cursor-pointer transition-all hover:-translate-y-1 shadow-md group"
              >
                <div className="space-y-2.5">
                  <div className="flex items-center justify-between">
                    ...
                    <ChevronRight className="w-4 h-4 text-slate-400 dark:text-slate-500 group-hover:text-blue-600 dark:group-hover:text-cyan-400 transform group-hover:translate-x-0.5 transition-transform" />
                  </div>

                  <h3 className="font-extrabold text-slate-900 dark:text-white text-base group-hover:text-blue-600 dark:group-hover:text-cyan-300 transition-colors">
                    {persona.title}
                  </h3>
                ...
                <div className="pt-3 border-t border-slate-200 dark:border-slate-800/80 flex items-center justify-between text-xs">
                  <span className="text-slate-500 dark:text-slate-400 font-medium">Track: <strong className="text-slate-800 dark:text-slate-200">{persona.careerTarget.split(' ')[0]}</strong></span>
          ...
          <div className="text-center pt-2">
            <button
              onClick={onEnterApp}
              className="inline-flex items-center space-x-2 text-xs font-bold text-slate-600 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white underline underline-offset-4 cursor-pointer"
            >
        ...
        <section className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {/* Step 1 */}
            <div className="bg-white dark:bg-slate-900/70 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 space-y-3 relative shadow-md">
              ...
              <h3 className="font-bold text-slate-900 dark:text-white text-base">Set Your Level & Career Goal</h3>
              <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
            ...
            <div className="bg-white dark:bg-slate-900/70 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 space-y-3 relative shadow-md">
              ...
              <h3 className="font-bold text-slate-900 dark:text-white text-base">Review AI Recommendations</h3>
              <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
            ...
            <div className="bg-white dark:bg-slate-900/70 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 space-y-3 relative shadow-md">
              ...
              <h3 className="font-bold text-slate-900 dark:text-white text-base">Build Timetable & Export</h3>
              <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
          ...
          <div className="space-y-3">
            {faqs.map((faq, idx) => {
              ...
              return (
                <div 
                  key={idx}
                  className="bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 rounded-2xl overflow-hidden shadow-xs transition-colors"
                >
                  <button
                    onClick={() => setActiveFaqIndex(isOpen ? null : idx)}
                    className="w-full p-4 sm:p-5 text-left font-bold text-slate-900 dark:text-white text-sm sm:text-base flex items-center justify-between gap-3 cursor-pointer"
                  >
                    <span>{faq.q}</span>
                    <span className={`p-1.5 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 shrink-0 transform transition-transform ${isOpen ? 'rotate-180' : ''}`}>
                      ↓
                    </span>
                  </button>
                  {isOpen && (
                    <div className="px-4 sm:px-5 pb-4 sm:pb-5 text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed border-t border-slate-100 dark:border-slate-800/80 pt-3">
                      {faq.a}
                    </div>
                  )}
                </div>
        ...
        <section className="bg-gradient-to-r from-blue-700 via-indigo-800 to-slate-900 dark:from-blue-900 dark:via-indigo-950 dark:to-slate-950 border border-blue-400/40 dark:border-blue-500/40 rounded-3xl p-8 sm:p-12 text-center space-y-6 shadow-2xl relative overflow-hidden">
          <div className="relative z-10 max-w-2xl mx-auto space-y-4">
            ...
            <p className="text-xs sm:text-sm text-indigo-100 dark:text-indigo-200">
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
              <button
                ...
                className="w-full sm:w-auto px-8 py-3.5 rounded-2xl bg-cyan-400 hover:bg-cyan-300 text-slate-950 font-black text-sm sm:text-base shadow-xl shadow-cyan-500/20 flex items-center justify-center space-x-2 transition-all transform hover:-translate-y-0.5 active:translate-y-0 cursor-pointer"
              >
